...
class LK21 {
	...
	Search(query) {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.198.206/?s=${encodeURIComponent(query)}#gsc.tab=0&gsc.q=${encodeURIComponent(query)}&gsc.page=1`)
				.then(async ({ data }) => {
					if (isAxiosError()) throw ('axios error');
					const $ = cheerio.load(data);
					let result = new Array();
					$("div.grid-archive > div#grid-wrapper > div.page-1 > article").each(function (a, b) {
	...
	Latest() {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.198.206/latest/page/${Math.floor(Math.random() * 4) + 1}`)
				.then(async ({ data }) => {
					if (isAxiosError()) throw ('axios error');
					const $ = cheerio.load(data);
					let result = new Array();
	...
	Ftv() {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.24.226/ftv/page/${Math.floor(Math.random() * 4) + 1}`, {
				headers: {
	...
	Series() {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.24.226/series/page/${Math.floor(Math.random() * 4) + 1}`)
				.then(async ({ data }) => {
					if (isAxiosError()) throw ('axios error');
					const $ = cheerio.load(data);
					let result = new Array();
	...
	Years(year) {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.24.226/year/${year}`)
				.then(async ({ data }) => {
					if (isAxiosError()) throw ('axios error');
					const $ = cheerio.load(data);
					let result = new Array();
	...
	Country(query) {
		return new Promise(async (resolve, reject) => {
			await axios.get(`https://149.56.198.206/country/${query.toLowerCase()}/page/${Math.floor(Math.random() * 4) + 1}`)
				.then(async ({ data }) => {
					if (isAxiosError()) throw ('axios error');
					const $ = cheerio.load(data);
					let result = new Array();
...
class FilmApik {
	...
	Search(query) {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/?s=${encodeURIComponent(query)}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
				.then(({ data }) => {
					...
					$("div.result-item > article").each(function (a, b) {
						result.push({
							...
							rating: $(this).find("div.details > div.meta > span.rating").text().split("IMDb ")[1],
							thumbnail: $(this).find("div.image > div.thumbnail > a > img").attr("data-src"),
	...
	Category(query) {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/category/${encodeURIComponent(query)}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
	...
	Years(query) {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/release-year/${encodeURIComponent(query)}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
	...
	Country(query) {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/negara/${encodeURIComponent(query)}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
	...
	Trending() {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/trending/page/${Math.floor(Math.random() * 5) + 1}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
	...
	Rating() {
		return new Promise((resolve, reject) => {
			axios.get(`https://5.182.209.205/ratings/page/${Math.floor(Math.random() * 5) + 1}`, {
				headers: {
					"User-Agent": "Mozilla/5.0 (Linux; Android 9; CPH1923) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36"
				}
			})
